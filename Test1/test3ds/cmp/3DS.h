...
{public:
	t3DObject()
	{pVerts=NULL;pNormals=NULL;
	pTexVerts=NULL;pFaces=NULL;};
	~t3DObject()
	{
	//delete[]pVerts ;   delete[] pNormals;
	//delete[]pTexVerts; delete[] pFaces;
	}
...
{
	public:
	t3DModel(){numOfObjects = numOfMaterials=0;}
	~t3DModel(){int i;for(i=0;i<pObject.size();i++) delete pObject[i];}
